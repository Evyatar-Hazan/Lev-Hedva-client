    ...
    <Box sx={{ p: 3 }}>
              ...
              <Card key={log.id}>
                <CardContent>
                  ...
                  <Typography
                    ...
                    sx={{ mb: 1 }}
                  >
                    <strong>{t("audit.description")}:</strong>{" "}
                    {log.description || "אין תיאור"}
                  </Typography>

                  <Typography variant="body2" color="text.secondary">
                    <strong>{t("audit.ipAddress")}:</strong>{" "}
                    {log.ipAddress || "N/A"}
                  </Typography>
                </CardContent>
      ...
      >
        ...
        <DialogContent>
          {selectedLogId &&
            (() => {
              const selectedLog = auditLogs.find(
                (log: any) => log.id === selectedLogId
              );
              if (!selectedLog)
                return (
                  <Typography>{t("audit.viewDetails.notFound")}</Typography>
                );
                ...
                <Box sx={{ pt: 2 }}>
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12} sm={6}>
                      ...
                      <Typography variant="body1" sx={{ mb: 2 }}>
                        {selectedLog.entityType ||
                          t("audit.viewDetails.notAvailable")}
                      </Typography>
                    </Grid>
                    <Grid item xs={12} sm={6}>
                      <Typography variant="subtitle2" color="text.secondary">
                    ...
                    <Grid item xs={12}>
                      ...
                      <Paper
                        sx={{ p: 2, backgroundColor: COLORS.grey[50], mt: 1 }}
                      >
                        <Typography variant="body2">
                          {selectedLog.description ||
                            t("audit.viewDetails.noDescription")}
                        </Typography>
                      </Paper>
                    </Grid>
